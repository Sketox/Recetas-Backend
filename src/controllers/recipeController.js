...
const createRecipe = async (req, res) => {
  ...
  if (!dto.isValid()) {
    ...
    console.log("- ingredients:", Array.isArray(dto.ingredients), dto.ingredients);
    console.log("- instructions:", Array.isArray(dto.instructions), dto.instructions);
    ...
    return res.status(400).json({ 
      ...
      details: "Revisa que todos los campos estén completos y sean del tipo correcto"
    });
  }
